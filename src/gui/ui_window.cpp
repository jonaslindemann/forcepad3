...
int gui::UiWindow::width()
{
    return m_width;
}

int gui::UiWindow::height()
{
    return m_height;
}

bool gui::UiWindow::autoPlacement()
{
    return m_autoPlacement;
}

void gui::UiWindow::setAutoPlacement(bool flag)
{
    m_autoPlacement = flag;
}

bool gui::UiWindow::canClose()
{
    return m_canClose;
}

void gui::UiWindow::setCanClose(bool flag)
{
    m_canClose = flag;
}
...
void gui::UiWindow::centerBottom()
{
    m_centerBottom = true;
}

void gui::UiWindow::center()
{
    m_center = true;
}

void gui::UiWindow::setPosition(int x, int y)
{
    m_x = x;
    m_y = y;
    m_newPos = true;
...
void gui::UiWindow::setPositionFromBottom(int x, int y)
{
    m_x = x;
    m_y = y;
    m_newBottomPos = true;
